...
@section('javascript')
	...
	{{HTML::script("js/js-fallecimiento.js?v=".rand(), array("type" => "text/javascript"))}}
...
@section('contenido')
	...
	<div class="row-border">
		...
		@if($tipo == 12)
			{{Form::open(array('action' => array('TramitesController@fallecimientoTitular_add'), 'method' => 'post', 'id' => 'formulario-fallecimiento', 'class'=>'form-horizontal'))}} 
		@endif
				...
				<div class="alert alert-warning col-sm-12" id="nueva_red">
					...
					<div id="datos_persona_fisica">
						...
						<div id="div_pers_fisica_a" class="form-group">	
							...
							<div class="col-sm-5">
							{{Form::text('apellido_mat', '', array('id' => 'id_apellido_mat', 'class'=>'form-control ' ,'maxlength' => '50','placeholder'=>'apellido materno', 'data-toggle'=>'tooltip', 'data-placement'=>'right','onfocus'=>'siguienteCampo = this.form.tipo_rel.id;nombreForm=this.form.id'))}}  
							</div>
						</div>	
						
						<div class="form-group">
								{{Form::label('ltipo_rel', 'Tipo Relación:', array('id'=>'ltipo_rel','class'=>'control-label col-xs-3'))}}
								<div class="col-sm-5">
								{{Form::select('tipo_rel', $tipo_tipo_rel, 3, array('id' => 'tipo_rel', 'class'=>'form-control', 'onfocus'=>'siguienteCampo = this.form.tipo_situacion.id;nombreForm=this.form.id'))}}
								</div>
						</div>
						
						<div class="form-group">
								{{Form::label('ltipo_vin', 'Tipo Vínculo:', array('id'=>'ltipo_vin','class'=>'control-label col-xs-3'))}}
								<div class="col-sm-5">
								{{Form::select('tipo_vin', $tipo_tipo_vin, 3, array('id' => 'tipo_vin', 'class'=>'form-control', 'onfocus'=>'siguienteCampo = this.form.nro_doc.id;nombreForm=this.form.id'))}}
								{{Form::hidden('tipo_vinh', '0' , array('id'=>'tipo_vinh'))}}
								</div>
						</div>
...
<!-- Anulado ADEN - 2024-07-19							
						<div class="form-inline col-lg-4">
							...
							{{Form::text('ingresos', '', array('id' => 'ingresos', 'class'=>'form-control col-xs-12' , 'maxlength' => '12', 'data-toggle'=>'tooltip', 'data-placement'=>'right','onfocus'=>'siguienteCampo = this.form.cbu.id;nombreForm=this.form.id'))}}  
...
-->									
					...
					<div class="form-group">	
						...
						<div class="col-sm-5">  
						{{Form::textarea('domicilio', $domicilio_agencia_f, array('id' => 'domicilio', 'class'=>"form-control input-medium",'maxlength'=>'255' , 'onfocus'=>'siguienteCampo = this.form.id_email.id;nombreForm=this.form.id', 'col'=>'50', 'rows'=>'3','readonly'))}}
						</div>
					</div>		
					<div class="form-group">	
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
						{{Form::text('localidades', $localidad_actual_f , array('id' => 'localidades', 'class'=>'form-control ' , 'data-toggle'=>'tooltip', 'data-placement'=>'right','autocomplete'=>'off','readonly'))}}  
						<!--
						<div class="col-sm-5">
							<input list="localidades" name="buscarLocalidad" id="buscarLocalidad" class='form-control' placeholder="Ingrese Localidad" autocomplete="off" onfocus='siguienteCampo=this.form.motivo_ct.id; nombreForm=this.form.id'>
									<datalist id="localidades" >
										<option value="{{ $localidad_actual_f.'('.$codigo_postal_f.'-'.$subcodigo_postal_f.')' }}" id="{{ $localidad_actual_id_f }}"></option>
									</datalist>
							@if( $errors->has('nueva_localidad'))
					              ...
					              @endforeach
					        @endif
							{{Form::hidden('nueva_localidad', $localidad_actual_id_f , array('id'=>'nueva_localidad'))}}
							{{Form::hidden('nombre_localidad', $localidad_actual_f , array('id'=>'nombre_localidad'))}}
							-->
						</div> 
							{{Form::hidden('nueva_localidad', $localidad_actual_id_f , array('id'=>'nueva_localidad'))}}
							{{Form::hidden('nombre_localidad', $localidad_actual_f , array('id'=>'nombre_localidad'))}}
...
-->						
				...
				<!-- FIN SE AGREGA 2024-07-19 -->

				
				<!-- ADJUNTO DE ARCHIVOS -->
<!-- antes - aden - 2024-07-17
				<div class="col-sm-12" id="div_adjuntos">
     despues - aden - 2024-07-19 -->				
				<div class="col-sm-12" id="div_adjuntos" style="display: none"> 
<!-- fin de cambio - aden -- 2024-07-19 -->				
					<!-- <div class="form-group"> -->				
