...
@section('javascript')
	...
	{{HTML::script("js/js-adjuntararchivos.js?var=".rand(), array("type" => "text/javascript"))}}	
	{{HTML::script('js/jquery.uploadfile.min.js', array('type'=>'text/javascript'))}}
	{{HTML::script('js/js-click.js?v=" . rand()', array('type'=>'text/javascript'))}}
@stop
...
@section('contenido')
	<div class="row">
		...
		<div class="col">
			<h1>Detalle de Trámite - {{$tramite['titulo']}} </h1> 
		</div>
	</div>	
	<div class="row-border">
		...
		@endif
			...
			<div class="form-group form-horizontal">
				...
				@endif
				<label class="control-label col-xs-5 col-sm-3" id="nro_seguimiento">Nº Seguimiento:</label> 
				<div class="col-sm-3">
				...
				@if((Session::get('usuarioLogueado.nombreTipoUsuario')=='CAS' 
					|| Session::get('usuarioLogueado.nombreTipoUsuario')=='CAS_ROS') 
					&& $tramite['id_estado_tramite']<7)
					
					@if($cant==0 || ($meses<0 && $dias<0) || $meses<0)
					@elseif($paso_fecha==0)<!--no paso fecha límite-->
							@if($meses==0)
								@if($dias==1)
									<div class="col-sm-5 col-lg-6 div_sin_padding alert-danger text-center">
			...
			<BR/>
				<div class="form-group form-horizontal">
					<label id="label_nro_permiso_" class="control-label  col-xs-3">Permiso:</label>
					<div class="col-sm-3">
			...
			@if($tramite['nuevo_permiso']==0)
				<div class="form-group form-horizontal">
					<label id="agente" class="control-label col-xs-3 ">Agente:</label>
					<div class="col-sm-3">
						<input type="text" class="form-control col-xs-3 text-right" value={{$tramite['agente']}}  disabled>
					</div>
			
					<label id="subagente_m" class="control-label col-xs-4 col-lg-3">Sub Agente:</label>
					<div class="col-sm-2">
				...
				@if($tramite['subagente']!=0)
					<div class="form-group form-horizontal">
						<label id="lred" class="control-label col-xs-4 col-sm-3 col-lg-3">Red:</label>
						<div class="col-sm-9 col-lg-8">
				...
				@endif
				<div class="form-group form-horizontal">
					@if($tramite['id_tipo_tramite']==3)
						<label id="ldomicilio" class="control-label col-xs-6 col-sm-3 ">Domicilio Particular:</label>
					@else
						<label id="ldomicilio" class="control-label col-xs-6 col-sm-3">Domicilio:</label>
					@endif
					<div class="col-sm-9 col-lg-8">
				...
				<BR/>
				<div class="form-group form-horizontal">
					<label id="llocalidad_m_" class="control-label col-xs-3 col-xs-pull-0 col-sm-3 col-sm-pull-0 col-lg-3 col-lg-pull-0">Localidad:</label>
					<div class="col-sm-5">
				...
				<BR/>
				<div class="form-group form-horizontal">
						<label id="observaciones" class="control-label col-xs-3">Motivo:</label> <!-- observaciones-->
			...
			@if($tramite['id_tipo_tramite']!=6 && $tramite['id_tipo_tramite']!=7)
				@if($tramite['id_tipo_tramite']!=2 ||  ($tramite['id_tipo_tramite']==2&& $tramite['suba_a_ag'] && $tramite['nuevo_permiso']==0))
					<div class="alert alert-warning form-group form-horizontal col-lg-12">
							...
							@elseif($tramite['id_tipo_tramite']==2 && $tramite['suba_a_ag']&& $tramite['nuevo_permiso']==0) 
								<label id="lnueva_categoria" class="control-label col-xs-4 col-lg-3">Nueva Red:</label>
										<div class="col-sm-3 col-lg-8">
							...
							@elseif($tramite['id_tipo_tramite']==11) <!-- Baja Cotitular -->
								<label id="lnuevo_titular" class="control-label col-xs-4 col-lg-3">CoTitular:</label>
								<div class="col-sm-3 col-lg-8">
									{{Form::text(
										'baja_cotitular',
										$tramite['cotitular']['nombre_titular'] . " (" . $tramite['cotitular']['nro_doc'] . ")",
										array(
											'id' => 'baja_cotitular',
			...
			<BR/>
				...
				@endif
				<div class="form-group form-horizontal">
						<label id="lestados_t_m" class="control-label col-xs-3">Estado Tr&aacutemite:</label>
						<div class="col-sm-5">
							@if(count($estados)==1
								||Session::get('usuarioLogueado.nombreTipoUsuario')=='AGENTE' 
								||Session::get('usuarioLogueado.nombreTipoUsuario')=='SUBAGENTE') 								
								{{Form::select('estados_t', $estados, 1, array('id' => 'estados_t','class'=>'form-control','style' => 'width:250px','disabled'))}}
							@else	
								{{Form::select('estados_t', $estados, $tramite['id_estado_tramite'], array('id' => 'estados_t', 'class'=>'form-control','style' => 'width:250px','autofocus'=>"",'onfocus'=>'siguienteCampo="textoComentarios_m"; nombreForm=this.form.id'))}}
							@endif
						</div>
				</div>
				...
				<div id="divCambioEstado" style="display: none">
					...
					<div class="form-group form-horizontal col-lg-12">
						...
						<div class="col-sm-8">	
							<textarea id="textoComentarios_m" class="form-control input-sm col-lg-push-11" name="textoComentarios_m" rows="4" cols="80" placeholder="Ingrese un comentario..."
							autofocus="" onfocus='siguienteCampo="btn_aplicar"; nombreForm=this.form.id'> </textarea>
						</div>
					</div>
					<div class="form-group form-horizontal col-sm-12">
						<input type="button" id="btn_aplicar" name="btn_aplicar" value="Aplicar" class="btn-primary col-sm-2 pull-right" onfocus='siguienteCampo = "fin";nombreForm=this.form.id'>
					</div>
				...
				<div id="divEstadosResolExp" class="alert alert-warning col-xs-12" style="display: none">
					<div id="divSubAAg" class="form-group form-horizontal" style="display: none">	
						@if ($tramite['id_tipo_tramite']==2) <!-- Cambio de categoria -->					
							@if($tramite['nuevo_permiso']==1)
							...
							<div class="form-group">
								<label id="lnro_nueva_red" for="lnro_nueva_red" class="control-label col-xs-3">Nº Nueva Red:</label>
							...
							<div class="form-group">
								{{Form::label('lcbu', 'CBU:', array('id'=>'lcbu','class'=>'control-label col-xs-5 col-lg-3'))}}
								<div class="col-sm-3">
					...
					<div id="divAgASub" class="form-group form-horizontal" style="display: none">		
						@if ($tramite['id_tipo_tramite']==2) <!-- Cambio de categoria -->
							<div class="form-group">
					...
					<div id="divCuit" class="form-group form-horizontal" style="display: none">
						@if ($tramite['id_tipo_tramite']==3 || $tramite['id_tipo_tramite']==8)   <!-- Cambio de titular / incorporar CO-TITULAR -->
							...
							<div class="form-group form-horizontal">
								{{Form::label('cuit', 'Cuit:', array('id'=>'lcuit','class'=>'control-label col-xs-5 col-sm-3'))}}
								<div class="col-xs-5 col-sm-3">
								{{Form::text('cuit', $tramite['persona_nt']['cuit'], array('id' => 'cuit', 'class'=>'form-control input-sm col-xs-3 text-right' ,'maxlength' => '13', 'data-toggle'=>'tooltip', 'data-placement'=>'right','onfocus'=>'siguienteCampo = this.form.tipo_persona.id;nombreForm=this.form.id','autocomplete'=>'off'))}}  
								</div>
							</div>
							<div class="form-group" id="div_tipo_persona">
								{{Form::label('ltipo_persona', 'Persona:', array('class'=>'control-label col-xs-5 col-sm-3'))}}
								<div class="col-xs-5 col-sm-3">
								...
								<div id="sexo_persona_fisica" class="form-group form-horizontal">
									<div class="form-group">
										{{Form::label('lsexo', 'Sexo:', array('class'=>'control-label col-xs-3 col-sm-2 col-lg-2'))}}
										<div class="col-xs-3 div_sin_padding col-sm-2 col-lg-2">
								...
								<div id='tipo_persona_juridica' class="form-group form-horizontal">
									<div class="form-group col-xs-12 col-sm-12 col-lg-12">
										{{Form::label('ltipo_sociedad', 'Tipo Sociedad: ', array('class'=>'control-label col-xs-5 col-sm-2 col-lg-3 div_sin_padding'))}}
							...
							<div class="form-group form-horizontal" id="div_ganancias">
								<div class="form-group">
									{{Form::label('ltipo_situacion_ganancia', 'Sit. GananciasX: ', array('class'=>'control-label col-xs-5 col-sm-3 col-lg-3'))}}
...
<!-- Anulado ADEN - 2024-04-24					
								<div class="form-group">
									{{Form::label('Nº Ingresos brutos:', '', array('id'=>'lingresos','class'=>'control-label col-xs-5 col-sm-3 col-lg-3'))}}
									<div class="col-xs-4 col-sm-3 col-lg-3" id="div_ingresos">
...
-->							
							<div class="form-group">	
								{{Form::label('Referente agencia:', '', array('id'=>'lreferente','class'=>'control-label col-xs-6 col-lg-3'))}}
								<div class="col-xs-6 col-xs-pull-1 col-sm-5 col-lg-5 col-lg-push-0">
							...
							<div class="form-group">	
								{{Form::label('Email:', '', array('id'=>'lemail','class'=>'control-label col-xs-5 col-lg-3'))}}
					...
					<div class="form-group form-horizontal">
						<label id="lresolucion" for="lresolucion" class="control-label col-xs-5 col-lg-3">Nº Resolución:</label>	
						<div class="col-xs-6 col-sm-5">
							<input id="resolucion" name="resolucion" type="text" class="form-control input-sm col-xs-3" value='' size="" onfocus='siguienteCampo="expediente"; nombreForm=this.form.id'>
						</div>
						<br/>
					</div>
					
					<div class="form-group form-horizontal">
						<label id="lexpediente" for="lexpediente" class="control-label col-xs-5 col-lg-3">Nº Expediente:</label>	
						<div class="col-xs-6 col-sm-5">
							<input id="expediente" name="expediente" type="text" class="form-control input-sm col-xs-3" value='' size="" onfocus='siguienteCampo="btn_aplicar_re"; nombreForm=this.form.id'>
						</div>
					</div>
					<br/>
					<div class="form-group form-horizontal">
						<input type="button" id="btn_aplicar_re" name="btn_aplicar_re" value="Aplicar" class="btn-primary col-lg-2 col-lg-push-2" onfocus='siguienteCampo = "fin";nombreForm=this.form.id'>
					</div>
					<BR/>
				</div>
		...
		<!-- ADJUNTO DE ARCHIVOS -->
		@if(Session::has('usuarioTramiteSinAdjunto'))
		...
		<div class="form-group form-horizontal">
			{{Form::label('ltipo_documento', 'Tipo de Documento:', array('id'=>'ltipo_documento','class'=>'control-label col-xs-5 col-lg-3 col-sm-5'))}}
				
			<div class="col-sm-5">
				{{Form::select('tipo_documento', $tipo_documento,'' ,array('id' => 'tipo_documento', 'class'=>'form-control col-sm-5 input-medium','style' => 'width:250px','autofocus'=>"",'onfocus'=>'siguienteCampo="btn_adjuntar";'))}}
			</div>
		</div><br>
			{{Form::button('Adjuntar archivos', array('id' => 'btn_adjuntar', 'name'=>'btn_adjuntar', 'class' => 'col-sm-3 glyphicon glyphicon-plus btn btn-success', 'disabled'))}}
		...
		<!-- FIN DE ADJUNTO DE ARCHIVOS -->
	
	
	
	<div id="botones" class="btn-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div id="botones2" class="btn-group">
			{{Form::open(array('action' => array('TramitesController@historialEstadoTramite'), 'method' => 'post', 'id' => 'formulario-historial','class'=>'formulario-historial'))}} 											
				{{Form::hidden('nroTramite',$tramite['nro_tramite'],  array('id' => 'nroTramite'))}}
				{{Form::submit('Historial Tramite', array('id' => 'btn-cargar-historial', 'name'=>'btn-cargar-historial', 'class' => 'btn btn-primary btn-sm col-sm-3'))}} 
			{{Form::close()}}
		</div>
		...
		<div id="div_btn_plan_pdf" class="btn-group" style="display:none">
			{{Form::button('Plan PDF', array('id' => 'btn_plan_pdf', 'name'=>'btn_plan_pdf', 'class' => 'btn btn-primary btn-sm'))}} 
		</div>
		<div id="div_btn_historial" class="btn-group">
				{{Form::button('Imprimir Historial', array('id' => 'btn_imprimir_historial', 'name'=>'btn_imprimir_historial', 'class' => 'btn btn-primary btn-sm col-sm-3'))}} 
		</div>
		<div id="btnes_car_sol" style="display:none">
			<div id="botones2" class="btn-group">
				{{Form::button('Imprimir Carátula', array('id' => 'btn-imprimir-caratula', 'name'=>'btn-imprimir-caratula', 'class' => 'btn btn-primary btn-sm col-sm-3'))}} 
			</div>
			<div id="botones2" class="btn-group">
				{{Form::button('Imprimir Solicitud', array('id' => 'btn-imprimir-nota', 'name'=>'btn-imprimir-nota', 'class' => 'btn btn-primary btn-sm col-sm-3'))}}
		</div>
		</div>

		
		<div id="div_btn_modificar_tramite" class="btn-group">
			<!-- Modificar tramite -->
			@if($puedeModificar)
				{{Form::open(array('action' => array('TramitesController@modificarTramite'), 'method' => 'post', 'id' => 'form_modif_tra','class'=>'form_modif_tra'))}}
					{{Form::hidden('nroTramite',$tramite['nro_tramite'],  array('id' => 'nroTramite'))}}
					{{Form::submit('Modificar Trámite', array('id' => 'btn_modificar_tramite', 'name'=>'btn_modificar_tramite', 'class' => 'btn btn-primary btn-sm col-sm-3'))}} 
				{{Form::close()}}
			@endif
	</div>
		@if(@tipoUsuario=='AGENTE' || @tipoUsuario == 'SUBAGENTE')
			<div id="div_btn_eval_dom" class="btn-group" style="display:none">
				{{Form::open(array('action' => array('TramitesController@cargarEvaluacionDomicilio'), 'method' => 'post', 'id' => 'formulario_evaluacion','class'=>'formulario_evaluacion'))}} 											
					{{Form::hidden('nroTramite',$tramite['nro_tramite'],  array('id' => 'nroTramite'))}}
					{{Form::submit('Inspección', array('id' => 'btn_eval_dom', 'name'=>'btn_eval_dom', 'class' => 'btn btn-primary btn-sm col-sm-3'))}}
				{{Form::close()}} 
			</div>
		@endif
	</div>
		...
		<div class="col-xs-12 col-xs-push-9 col-sm-12 col-sm-push-10 col-md-12 col-md-push-10 col-lg-12">
			{{Form::button('Cerrar', array('id' => 'btn_cerrar', 'name'=>'btn_cerrar', 'class' => 'btn-primary pull-left', 'onclick'=>'consultar2(APP_URL);'))}}
		</div>
	</div>
@endsection
...
<div id="modal_adjunto_ok" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-sm">
        <div class="modal-content" id="modal-content">
			<div class="modal-header">
			 ...
			 <div class="modal-body">
				  <h3>Su archivo se adjunto correctamente.<h3>
			</div>
			<div class="modal-footer" id="btn-cerrar-modal">
