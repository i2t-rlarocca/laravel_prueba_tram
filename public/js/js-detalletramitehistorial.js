...
jQuery(document).ready(function(){
     ...
     /***Funciones para cargar y mostrar el historial del trámite en la vista de consulta**/
...
var usu='';
  ...
  jQuery('#cuerpo').on('click', 'td', function () {
      //if(jQuery(location).attr('href').indexOf('detalle-tramite-nro-seguimiento')<0){
...
/**
* Pasa el mensaje del botón historial de show a off o al revés.
**/
